<div class="twelve columns upcoming-eps">
	<div  class="large-behind-text">
			<img class="bg-text"  alt="The Goldbergs Upcoming Episode Info and Pictures| Wendi McLendon-Covey Fansite" src="<?php bloginfo('template_url') ?>/assets/images/goldbergs.png">
		</div>
